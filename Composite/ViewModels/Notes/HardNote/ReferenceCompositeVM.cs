...
{
    public partial class ReferenceCompositeVM : CompositeBaseVM, IDisposable
    {
        ...
        public ReferenceCompositeVM(ITabService tabService, IHardNoteService hardNoteService, IMessenger messenger)
        {
        ...
        [RelayCommand] async Task CheckValuRef(ReferenceCompositeVM refComposite) => _hardNoteService.CheckValuRef(refComposite);
        ...
        public override object Clone() => new ReferenceCompositeVM(_tabService, _hardNoteService, _messenger)
        {
            Id = Guid.NewGuid(),
            ValueRef = ValueRef,
            Text = Text
